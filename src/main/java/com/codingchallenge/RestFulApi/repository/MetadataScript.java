...
public class MetadataScript {
    ...
    public static final String exerciseList= " SELECT  u.last_name as UserName, u.id as UserId,e.id as ExerciseId ,e.name as Exercise,s.score as Score ,ROW_NUMBER () OVER ( partition BY e.name) as Count From Score s " +
